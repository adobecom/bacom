...
describe('Libs', () => {
  const tests = [
    ...
    ['https://main--bacom--adobecom.aem.page/', 'https://hlx5-upgrade--milo--adobecom.aem.live/libs'],
    ...
    ['https://main--bacom--adobecom.aem.live/', 'https://hlx5-upgrade--milo--adobecom.aem.live/libs'],
    ...
    ['http://localhost:3000', 'https://hlx5-upgrade--milo--adobecom.aem.live/libs'],
